...
public class Robot extends TimedRobot {
  public static TestDrive m_TestDrive = TestDrive.getInstance();
  public static Controls m_oi = Controls.getInstance();
  public static Limelight m_Limelight  = Limelight.getInstance();
  private Notifier PeriodicIO = new Notifier(() -> {LogManager.getInstance().logPeriodicIO();});
